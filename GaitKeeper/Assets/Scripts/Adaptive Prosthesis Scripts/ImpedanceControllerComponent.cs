...
{
    public class ImpedanceControllerComponent : ActuatorComponent
    {
        [SerializeField]
        ...
        public override IActuator[] CreateActuators()
        {
            if (actuator == null)
            {
                actuator = new ImpedanceActuator(this);
            }
            return new[] { actuator };
        }

        class ImpedanceActuator : IActuator
        {
            ImpedanceControllerComponent component;

            public ImpedanceActuator(ImpedanceControllerComponent component)
            {
